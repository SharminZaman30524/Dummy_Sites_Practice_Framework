...
public class Common {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      ...
                      String browserVersion, @Optional("https://www.apartments.com/") String url) throws IOException {
...
((FluentWait<?>) wait).withTimeout(Duration.ofSeconds(5));
...
wait.ignoring(NoSuchElementException.class);
    ...
    public void captureScreenshot(String screenshotName) {
        ...
        try {
            FileUtils.copyFile(file, new File(System.getProperty("user.dir")+File.pathSeparator+ "screenshots"+File.pathSeparator+screenshotName+" "+".png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
